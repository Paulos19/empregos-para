const STEPS = [
  { title: "Adicionar um PDF", text: "ou criar a partir da nossa ferramenta" },
  { title: "Se atentar ao Preview", text: "e fazer mudanças" },
  { title: "Baixe seu currículo", text: "e o encaminhe com segurança" },
];
