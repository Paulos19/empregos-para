/*
  ...
  - You are about to drop the column `status` on the `Charge` table. All the data in the column will be lost.
  - Added the required column `chargeStatus` to the `Charge` table without a default value. This is not possible if the table is not empty.
