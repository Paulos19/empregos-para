/*
  ...
  - Added the required column `chargeId` to the `User` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_User" (
    ...
    CONSTRAINT "User_chargeId_fkey" FOREIGN KEY ("chargeId") REFERENCES "Charge" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
